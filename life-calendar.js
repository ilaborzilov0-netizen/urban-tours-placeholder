...
(function () {
      var root = document.getElementById('bz-life-calendar');
      if (!root) return;
      ...
      var ageRange = root.querySelector('#bzlc-age');
      var ageNumber = root.querySelector('#bzlc-age-num');
      var birthPanel = root.querySelector('#bzlc-birth-panel');
      var birthInput = root.querySelector('#bzlc-birthdate');
      var birthReset = root.querySelector('#bzlc-birth-reset');
      var modePill = root.querySelector('#bzlc-mode-pill');
      var cutToggle = root.querySelector('#bzlc-cut-toggle');
      ...
      var grid = root.querySelector('#bzlc-grid');
      var gridWrap = root.querySelector('.bzlc-grid-wrap');
      var smoke = root.querySelector('#bzlc-smoke');
      var scaleMark = root.querySelector('#bzlc-scale-mark');
